// src/components/Layout/ProviderTopbar.jsx
...
const ProviderTopbar = ({
  ...
  const topbarStyles = `
    ...
    /* Dark Theme */
    [data-theme="dark"] .provider-topbar {
      ...
      <header className="provider-topbar">
        <div className="topbar-left">
          ...
          <div className="page-info">
            <h4 className="page-title">Provider Dashboard</h4>
          </div>
        </div>
        ...
        <div className="topbar-right">
              ...
              <div className="dropdown-menu">
                ...
                {notifications.length > 0 && (
                  <div className="dropdown-footer">
                    <Link to="/provider/notifications" className="dropdown-footer-link">
          ...
          <div className="dropdown-wrapper" ref={profileRef}>
            <button className="profile-btn" onClick={() => setProfileMenuOpen(!profileMenuOpen)}>
              ...
              <div className="profile-btn-info">
                <span className="profile-btn-name">{user?.name?.split(' ')[0] || 'Provider'}</span>
                <span className="profile-btn-role">Provider</span>
              </div>
            </button>
            ...
            {profileMenuOpen && (
              <div className="profile-dropdown">
                <div className="profile-dropdown-header">
                  ...
                  />
                  <div>
                    <p className="profile-dropdown-name">{user?.name || 'Provider'}</p>
                    <p className="profile-dropdown-email">{user?.email || 'provider@servicehub.com'}</p>
                  </div>
                </div>
                <div className="profile-dropdown-items">
                  <Link to="/provider/profile" className="profile-dropdown-link">
                    <FaUser size={14} /> Profile
                  </Link>
                  <Link to="/provider/wallet" className="profile-dropdown-link">
                    <FaWallet size={14} /> Wallet: {formatNaira(walletBalance)}
                  </Link>
                  <Link to="/provider/settings" className="profile-dropdown-link">
          ...
          {/* Add Service Button */}
          <Link to="/provider/create-service" className="book-btn">
            <FaPlus size={14} />
