...
const AdminTopbar = ({
  ...
  const getNotificationIcon = (type) => {
    const icons = {
      ...
      payment: { icon: FaClock, color: '#14b8a6' },
      review: { icon: FaStar, color: '#f59e0b' },
      alert: { icon: FaClock, color: '#ef4444' },
      approval: { icon: FaCalendarCheck, color: '#8b5cf6' },
    };
    ...
    <>
      ...
      <header className="admin-topbar">
        ...
        <div className="topbar-right">
              ...
              <div className="dropdown-menu">
                ...
                {notifications.length > 0 && (
                  <div className="dropdown-footer">
                    <Link to="/admin/notifications" className="dropdown-footer-link">
          ...
          <div className="dropdown-wrapper" ref={profileRef}>
            <button className="profile-btn" onClick={() => setProfileMenuOpen(!profileMenuOpen)}>
              ...
              <div className="profile-btn-info">
                <span className="profile-btn-name">{user?.name?.split(' ')[0] || 'Admin'}</span>
                <span className="profile-btn-role">Administrator</span>
              </div>
            </button>
            ...
            {profileMenuOpen && (
              <div className="profile-dropdown">
                <div className="profile-dropdown-header">
                  ...
                  />
                  <div>
                    <p className="profile-dropdown-name">{user?.name || 'Administrator'}</p>
                    <p className="profile-dropdown-email">{user?.email || 'admin@servicehub.com'}</p>
                  </div>
                </div>
                <div className="profile-dropdown-items">
                  <Link to="/admin/profile" className="profile-dropdown-link">
                    <FaUser size={14} /> Profile
                  </Link>
                  <Link to="/admin/settings" className="profile-dropdown-link">
          ...
          {/* Reports Button */}
          <Link to="/admin/reports" className="report-btn">
            <FaChartLine size={14} />
            <span>Reports</span>
          </Link>
        </div>
